<script lang="ts">
	...
	const modules: Module[] = [
		...
		},
		{
			id: 'body',
			name: 'Body',
			desc: 'Apple Health integration — sleep, HRV, resting heart rate, steps, and wellness trends.',
			status: 'active',
			href: '/body',
			icon: 'health',
		...
		},
		{
			id: 'vitality',
			name: 'Vitality',
			desc: 'Cognitive measurement — how you think, learn, and evolve. Depth, coherence, complexity, and flow.',
			status: 'active',
			href: '/vitality',
			icon: 'vitality',
			features: ['Cognitive profile', 'Complexity tracking', 'Flow detection', 'Semantic growth'],
		},
		{
			id: 'activity',
			name: 'Activity',
			desc: 'Screen time, app usage, productivity scores, and message volume across all channels.',
			status: 'active',
			href: '/activity',
			icon: 'activity',
			features: ['App tracking', 'Screen time', 'Productivity', 'Message volume'],
		},
	];
...
<div class="flex-1 overflow-y-auto max-w-2xl mx-auto px-8 py-8 w-full">
