...
export const METRIC_FAMILIES: FamilyDef[] = [
	...
	},
	{
		...
		surfaced: true,
		vocab: 'routine / rhythm-of-day (descriptive — NOT clinical circadian diagnosis)',
		metrics: [
			{ key: 'diurnal_peak_hour', name: 'Peak hour', meaning: 'The hour of day you write most.' },
			{ key: 'diurnal_concentration', name: 'Time concentration', meaning: 'How concentrated your writing is around that peak vs spread through the day.' },
			{ key: 'diurnal_entropy', name: 'Time spread', meaning: 'How evenly your writing is distributed across the 24 hours.' },
