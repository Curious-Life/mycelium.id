...
export const SOURCE_CATALOG: SourceEntry[] = [
	...
	{ id: 'claude-code', name: 'Claude Code', status: 'soon', color: 'var(--color-accent-teal)', logo: L.claudecode,
		blurb: 'Your coding sessions & transcripts.',
		howto: 'Direct session-transcript import is coming. (Live sessions are captured automatically when enabled.)' },
