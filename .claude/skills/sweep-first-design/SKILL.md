...
- The egress-provenance refactor (Phases 0-7) is the canonical example of this protocol in practice. Read [docs/EGRESS-PROVENANCE-PHASE2-DESIGN-2026-05-06.md](../../../docs/EGRESS-PROVENANCE-PHASE2-DESIGN-2026-05-06.md) for the format the verification-table + revision-history + sweep-findings sections should follow.
