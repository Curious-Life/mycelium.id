...
<div class="connections-checklist" class:compact>
	...
	{#if expandedStep === 'telegram'}
		<div class="step-guide">
			...
			<div class="guide-input-row">
				<input type="text" bind:value={telegramTokenInput} placeholder="123456:ABC-DEF..." autocomplete="off" data-1p-ignore class="guide-input" />
				<button class="guide-save-btn" disabled={!telegramTokenInput || integrationSaving} onclick={() => saveIntegration('TELEGRAM_BOT_TOKEN', telegramTokenInput, 'personal')}>
