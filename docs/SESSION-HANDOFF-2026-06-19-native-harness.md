...
State: scheduled_tasks · harness_runs · conversation_summaries · channel_write_audit (migration 0034).
```
...
- `src/db/harness.js` + `migrations/0034_channel_write_audit.sql` — write-audit DAL + table.
