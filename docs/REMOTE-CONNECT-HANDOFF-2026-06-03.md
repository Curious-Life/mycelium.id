...
| **Live-infra smoke** (real relay/DNS/CA/phone) | — | ⬜ NEXT — now **much narrower**: transport + auth both locally proven; remaining = public CA via DNS-01/acme-dns, real DNS routing, real phone MCP client, `cargo tauri build` |
