-- Migration: Create secure function for public share link access
-- This function runs with elevated privileges but only returns specific shared content
...
REVOKE EXECUTE ON FUNCTION get_shared_content(TEXT, TEXT) FROM authenticated;
REVOKE EXECUTE ON FUNCTION get_shared_content(TEXT, TEXT) FROM PUBLIC;
