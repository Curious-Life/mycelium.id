...
// See ann/decode.js for the rationale: the canonical src/crypto/crypto-local.js
// is a foundation placeholder in this branch; the working module-level envelope
// API is the verified spike. V1's in-RAM search path does not persist the index
// (no persistPath wired), so saveIndex/loadIndex are never called on the live
// path — this import only needs to resolve. Re-point once the foundation ships
// the real src/crypto/crypto-local.js module-level export.
import { encrypt, decrypt } from '../../../spike/crypto/crypto-local.js';
